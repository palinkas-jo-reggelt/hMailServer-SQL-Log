...
$EnvFromRows = "
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col right' data-column='Count'>128</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col right' data-column='Count'>41</div>
					<div class='div-table-col right' data-column='Percent'>1.5%</div>
				</div>
				<div class='div-table-row'>
...
$EnvToRows = "
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col right' data-column='Count'>300</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col right' data-column='Count'>51</div>
...
$TopTenIPsRows = "
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>1,632,642</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col' data-column='Country'>United States</div>
					<div class='div-table-col center' data-column='Hits'>2,802</div>
					<div class='div-table-col center' data-column='Percent'>0.2%</div>
				</div>
				<div class='div-table-row'>
...
$TopTenCountriesRows = "
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>96,301</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>12,369</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>6,714</div>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>5,738</div>
					<div class='div-table-col center' data-column='Percent'>0.3%</div>
				</div>
				<div class='div-table-row'>
				...
				<div class='div-table-row'>
					...
					<div class='div-table-col center' data-column='Hits'>5,405</div>
					<div class='div-table-col center' data-column='Percent'>0.3%</div>
				</div>
				<div class='div-table-row'>
					<div class='div-table-col' data-column='Country'><a href='./data.php?search=Hong+Kong'>Hong Kong</a></div>
					<div class='div-table-col center' data-column='Hits'>4,285</div>
					<div class='div-table-col center' data-column='Percent'>0.2%</div>
				</div>
				<div class='div-table-row'>
